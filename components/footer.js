        ...
        <div>
          <a href='https://x.com/idemirer' alt='twitter' target='_blank' aria-label='X.com @idemirer'>
            <svg
              ...
              width={24}
              height={24}
              className='fill-black drop-shadow-[1px_1px_1px_rgba(10,10,10,0.5)] dark:drop-shadow-[1px_1px_1px_rgba(0,0,0,.6)] hover:drop-shadow-[1px_1px_1px_rgba(0,0,0,1)] dark:hover:drop-shadow-[1px_1px_1px_rgba(100,100,100,0.5)]'
            >

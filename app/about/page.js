...
export default async function Page() {
  ...
  return (
    <section className='about'>
      ...
      <div className=''>
        <Link
          href='/resume/Ilhan-Demirer-CV.pdf'
          className='cv flex gap-1 py-2 font-bold hover:text-red-700 w-fit'
          target='_blank'
        >
          <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512' width={24} height={24} className='fill-red-700'>

      ...
      <div>
        ...
        <div className='flex space-x-4 font-bold py-2'>
          <svg
            ...
            width={24}
            height={24}
            className='fill-[#0e76a8] drop-shadow-[1px_1px_1px_rgba(86,86,86,0.9)] dark:drop-shadow-[1px_1px_1px_rgba(0,0,0,.6)]'
          >
        ...
        <div className='flex space-x-4 font-bold py-2'>
          <svg
            ...
            width={24}
            height={24}
            className='fill-[#00ccbb] drop-shadow-[1px_1px_1px_rgba(86,86,86,0.9)] dark:drop-shadow-[1px_1px_1px_rgba(0,0,0,.6)]'
          >
        ...
        <div className='flex space-x-4 font-bold py-2'>
          <svg
            ...
            width={24}
            height={24}
            className='fill-(--text) drop-shadow-[1px_1px_1px_rgba(10,10,10,0.5)] dark:drop-shadow-[1px_1px_1px_rgba(0,0,0,.6)]'
          >

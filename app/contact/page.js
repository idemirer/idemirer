  ...
  return (
    <section>
      ...
      <div className='flex space-x-4 font-bold py-2'>
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 448 512' width={24} height={24} className='fill-[#00ccbb]'>
      ...
      <div className='flex space-x-4 font-bold py-2'>
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 448 512' width={24} height={24} className='fill-[#0e76a8]'>
